...
const PhotoUpload: React.FC<PhotoUploadProps> = ({ onBack, onNext }) => {
  ...
  const getContainerClasses = () => {
    if (isMobile) {
      return "w-full mx-auto overflow-y-auto overflow-x-hidden pb-4";
    } else {
      return "w-full mx-auto overflow-y-auto overflow-x-hidden pb-4";
    }
  };
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-6">
        ...
        <h2 className="text-2xl font-semibold">Upload Your Photos & Videos</h2>
      </div>
      
      {/* Category buttons */}
      <div className="flex overflow-x-auto flex-nowrap space-x-3 pb-3 mb-4 w-full lg:max-w-[340px] xl:max-w-[335px]">
      ...
      {/* Upload area */}
      <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 md:p-6 mb-6 max-w-xs w-full mx-auto md:max-w-sm lg:max-w-[340px] xl:max-w-[335px]">
      ...
      {/* Single Upload & Continue button */}
      <div className="mt-8 flex justify-center md:block max-w-xs mx-auto md:max-w-sm lg:max-w-[340px] xl:max-w-[335px]">
        <Button 
          onClick={handleNext} 
          className="w-full max-w-xs bg-primary text-white hover:bg-primary/90 h-12 md:max-w-full"
          disabled={isUploading}
        >
