...
const SellHero: React.FC<SellHeroProps> = ({
  ...
  return (
    <section className="relative w-full sm : pt-12 z-10 min-h-[100dvh] lg:min-h-[950px] xl:min-h-[800px] 2xl:min-h-[850px] flex items-stretch transition-colors duration-500">
