      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 pt-6 lg:pt-24 pb-6">
          <div className="flex items-center text-sm text-muted-foreground mb-4">
            ...
            <Link to="/search?type=car" className="hover:underline">Buy Cars</Link>
            <ChevronRight className="h-3 w-3 mx-2" />
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 mb-8 shadow-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <span className="font-semibold text-foreground">{car.fuel_type ? car.fuel_type : 'No Data'}</span>
                  </div>
                  
                  <div className="flex flex-col items-center text-center">
                    <User className="h-6 w-6 text-muted-foreground mb-2" />
                    <span className="text-sm text-muted-foreground">No. of Owners</span>
                    <span className="font-semibold text-foreground">{car.number_of_owners != null ? car.number_of_owners : 'No Data'}</span>
                  </div>
                  
                  <div className="flex flex-col items-center text-center">
                    <Gauge className="h-6 w-6 text-muted-foreground mb-2" />
                    <span className="text-sm text-muted-foreground">KM Driven</span>
                    <span className="font-semibold text-foreground">{car.kilometers_driven === 0 ? 'NA' : car.kilometers_driven != null ? car.kilometers_driven.toLocaleString() : 'No Data'}</span>
                  </div>
                </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-sm font-medium text-foreground">{car.year}</span>
                      </div>
                      
                      <div className="flex flex-col items-center text-center">
                        <Gauge className="h-5 w-5 text-muted-foreground mb-1" />
                        <span className="text-xs text-muted-foreground">KM Driven</span>
                        <span className="text-sm font-medium text-foreground">{car.kilometers_driven === 0 ? 'NA' : car.kilometers_driven != null ? car.kilometers_driven.toLocaleString() : 'No Data'}</span>
                      </div>
                      
                      <div className="flex flex-col items-center text-center">
                        {getFuelIcon(car.fuel_type)}
                        <span className="text-xs text-muted-foreground">Fuel</span>
                        <span className="text-sm font-medium text-foreground">{car.fuel_type ? car.fuel_type : 'No Data'}</span>
                      </div>
                    </div>
